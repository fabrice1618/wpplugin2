...
function reservation_evenements_getform( $postId ) {
    ...
    if (is_user_logged_in()) {
        echo '<p>Nombre de places disponibles</p>';

        printf(RESERVATION_TEMPLATE,
                    get_site_url() . '/evenements/',
                    wp_nonce_field('reserver', 'reservation-verif'),    // Token protection CSRF
                    $postId);
    } else {
...
// Traitement des données du formulaire des reservations 
